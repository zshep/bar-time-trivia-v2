...
export default function Home() {
  return (
    <div className="mt-40 w-full px-4 py-4 sm:py-6 md:py-0 md:flex md:items-center">
          ...
          <div className="w-full md:w-1/2">
            <div className="mx-auto flex flex-col items-center text-center md:mx-0 md:items-start md:text-left md:max-w-sm">
              ...
              <p className="atma-thin mt-4 sm:mt-5 text-sm sm:text-base leading-snug">
                Bar Style Trivia in the palm of your hand. Log in to create
                trivia games, run a trivia session, or play live using your
                player profile.
              </p>
            </div>
          </div>
